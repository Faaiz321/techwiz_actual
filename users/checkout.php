    ...
    <div class="main-content">
      <!--breadcrumb-->
        ...
        <div class="row">
							...
							<div class="card-body p-4">
								<form class="row g-3 needs-validation" novalidate>
									<div class="col-md-12">
										...
										<input type="text" class="form-control" id="bsValidation1" placeholder="Address"  required>
									...
									<div class="col-md-12">
										...
										<input type="phone" class="form-control" id="bsValidation3" placeholder="Phone" required>
                    ...
                    <input type="text" class="form-control" id="bsValidation4" placeholder="Country" required>
									</div>
									...
									<div class="col-md-12 my-3">
										<div class="d-md-flex d-grid align-items-center gap-3">
											<button type="submit" class="btn btn-grd-primary px-4 col-md-12">Submit</button>
										</div>
									</div>
								</form>
							</div>
