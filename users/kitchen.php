...
<div class="card container">
<img class="card-img-top container" style="width: 403.38px; height: 239.5px;" src="assets/images/kitchen/kitchen6.jpg" alt="Card image cap">
<div class="card-body">
...
<div class="card container">
<img class="card-img-top" style="width: 403.38px; height: 239.5px;" src="assets/images/kitchen/kitchen1.jpg" alt="Card image cap">
<div class="card-body">
<h5 class="card-title">Card title</h5>
...
<div class="card container">
<img class="card-img-top" style="width: 353.38px; height: 239.5px;" src="assets/images/kitchen/kitchen2.jpg" alt="Card image cap">
<div class="card-body">
<h5 class="card-title">Card title</h5>
...
<div class="card container">
<img style="width: 403.38px; height: 239.5px;" class="card-img-top" src="assets/images/kitchen/kitchen3.jpg" alt="Card image cap">
<div class="card-body">
<h5 class="card-title">Card title</h5>
<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
<p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
...
<div class="card container">
<img class="card-img-top" style="width: 403.38px; height: 239.5px;" src="assets/images/kitchen/kitchen4.jpg" alt="Card image cap">
<div class="card-body">
<h5 class="card-title">Card title</h5>
<p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
<p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
...
<div class="card container">
<img class="card-img-top" style="width: 350.38px; height: 239.5px;" src="assets/images/kitchen/kitchen5.jpg" alt="Card image cap">
<div class="card-body">
<h5 class="card-title">Card title</h5>
<p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
<p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
